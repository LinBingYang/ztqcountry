...
@implementation ChineseHoliDay

+(NSString *)getLunarHoliDayDate:(NSDate *)date{
    
    NSTimeInterval timeInterval_day = 60*60*24*1.0;
    ...
    NSString *key_str = [NSString stringWithFormat:@"%ld-%ld",localeComp.month,(long)localeComp.day];
