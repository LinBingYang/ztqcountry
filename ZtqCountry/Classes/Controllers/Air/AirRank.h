...
#import "ShareSheet.h"
#import "weiboVC.h"
@interface AirRank : UIViewController<UITableViewDelegate, UITableViewDataSource,AirDialogDelegate,CityDialogDelegate,MFMessageComposeViewControllerDelegate,UIGestureRecognizerDelegate>{
    UITableView *m_tableView;
	NSMutableArray *m_tableData;
    UIButton *kqzl_button;//空气质量
    UIButton *air_button;//空气质量指数说明
    UIButton *order_button;//排序按钮
    UIButton *city_button;//城市弹窗按钮
