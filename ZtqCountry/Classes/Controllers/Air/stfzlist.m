...
//    [button setBackgroundImage:[UIImage imageNamed:@"气象产品新_03.png"] forState:UIControlStateNormal];
    ...
    UIImageView *xiaimg=[[UIImageView alloc]initWithFrame:CGRectMake(button.frame.size.width-20, 8, 13, 13)];
...
- (UITableViewCell*) tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    //文本标签
    UILabel *lab=[[UILabel alloc]initWithFrame:CGRectMake(3, 0, oldFrame.size.width, 30)];
...
- (void) tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (self.delegate && [self.delegate respondsToSelector:@selector(stfzdidSelect:withIndex:)]){
        [self.delegate stfzdidSelect:self withIndex:indexPath.row];
    }
}
