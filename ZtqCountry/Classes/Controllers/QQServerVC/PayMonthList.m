...
- (void) drawView{
    ...
    UIImageView *xiaimg=[[UIImageView alloc]initWithFrame:CGRectMake(button.frame.size.width-20, 8, 15, 15)];
...
- (void) tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (self.delegate && [self.delegate respondsToSelector:@selector(monthlistdidSelect:withIndex:)]){
        [self.delegate monthlistdidSelect:self withIndex:indexPath.row];
    }
}
