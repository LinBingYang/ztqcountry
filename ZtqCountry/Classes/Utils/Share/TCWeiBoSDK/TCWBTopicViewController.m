...
//    [searchbar release];
    ...
    if ([[[UIDevice currentDevice] systemVersion] floatValue] >= 6.0) {
        UITableView *tableview = [[UITableView alloc] initWithFrame:CGRectMake(0, 44, self.view.width, 416 + 88) style:UITableViewStylePlain];
...
//        [tableview release];
        ...
        UITableView *tableview = [[UITableView alloc] initWithFrame:CGRectMake(0, 44, self.view.width, 416) style:UITableViewStylePlain];
        [tableview setTag:TAG_TABLEVIEW];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (imageviewSeparator == nil) {
        ...
        imageviewSeparator = [[UIImageView alloc] initWithFrame:CGRectMake(0, 44 - 1, self.view.width, 1)];
