...
- (void)loadView
{
    if ([[[UIDevice currentDevice] systemVersion] floatValue] >= 6.0) {
        UIView *viewMain = [[UIView alloc] initWithFrame:CGRectMake(0, 0, self.view.width, 416 + 88)];
        self.view = viewMain;
//        [viewMain release];
    }else {
        UIView *viewMain = [[UIView alloc] initWithFrame:CGRectMake(0, 0, self.view.width, 416)];
        self.view = viewMain;
//        [viewMain release];
    }
}
...
- (void)viewDidLoad
{
    ...
    [imageviewNavigation setFrame:CGRectMake(0, 0, self.view.width, 44)];
...
//    [imageviewNavigation release];
    ...
    [labelTitle setFrame:CGRectMake((self.view.width - szTitle.width)/2, (44 - szTitle.height)/2, szTitle.width, szTitle.height)];
...
//    [labelTitle release];
    ...
    // 搜索框
    UISearchBar *searchbar = [[UISearchBar alloc] initWithFrame:CGRectMake(0, 44, self.view.width, 44)];
...
//    [searchbar release];
    ...
    // 列表框
    if ([[[UIDevice currentDevice] systemVersion] floatValue] >= 6.0) {
        UITableView *tableview = [[UITableView alloc] initWithFrame:CGRectMake(0, 88, self.view.width, 372 + 88) style:UITableViewStylePlain];
...
//        [tableview release];
        ...
        UITableView *tableview = [[UITableView alloc] initWithFrame:CGRectMake(0, 88, self.view.width, 372) style:UITableViewStylePlain];
        [tableview setTag:TAG_TABLEVIEW_FRIEND];
...
//    UITableView *tableview = [[UITableView alloc] initWithFrame:CGRectMake(0, 88, 320, 372) style:UITableViewStylePlain];
    ...
    // 覆盖层
    UIControl *controlLayer = [[UIControl alloc]initWithFrame:CGRectMake(0, 88, self.view.width, 372)];
...
//	[controlLayer release];
    ...
    UINoteView *noteview = [[UINoteView alloc] initWithFrame:CGRectMake((self.view.width - NOTEVIEW_WIDTH)/2, 85, NOTEVIEW_WIDTH, NOTEVIEW_HEIGHT)];
...
//        [labelNick release];
    ...
    if (imageviewSeparator == nil) {
        ...
        imageviewSeparator = [[UIImageView alloc] initWithFrame:CGRectMake(0, TABLEVIEWCELL_HEIGHT - 1, self.view.width, 1)];
