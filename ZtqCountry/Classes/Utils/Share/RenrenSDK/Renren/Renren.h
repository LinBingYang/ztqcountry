...
@interface Renren: NSObject <RODialogDelegate, RORequestDelegate> {
	...
	__strong NSString *_secret;
	__strong NSString *_sessionKey;
	__strong NSDate *_expirationDate;
	__strong NSString *_createTime;
	__strong RORequest *_request;
	__strong NSString *_appId;
	__strong NSString *_appKey;
	__strong NSArray *_permissions;
//	id <RenrenDelegate> _renrenDelegate;
    __weak id <RenrenDelegate> _renrenDelegate;
}
...
@property(nonatomic, weak) id<RenrenDelegate> renrenDelegate;

@property(nonatomic, strong) NSArray *permissions;

@property(nonatomic, strong) RORequest *request;
