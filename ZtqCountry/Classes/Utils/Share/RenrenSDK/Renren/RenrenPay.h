...
//    id<RenrenPayDelegate> _delegate;
    __weak id<RenrenPayDelegate> _delegate;
    ROPayOrderInfo *_tempOrder;
    NSString *_appSecret;
    BOOL _isTest;
}
@property (strong ,nonatomic)ROPayOrderDao *payDao;
@property (strong ,nonatomic)Renren *renren;
@property (strong ,nonatomic)RORequest *payRequest;
@property (weak ,nonatomic)id<RenrenPayDelegate> delegate;
@property (assign ,nonatomic)BOOL isTest;
@property (strong ,nonatomic)ROPayOrderInfo *tempOrder;
