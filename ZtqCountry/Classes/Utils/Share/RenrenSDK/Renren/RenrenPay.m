...
//    NSMutableString *calcStr = [[[NSMutableString alloc] init] autorelease];
    NSMutableString *calcStr = [[NSMutableString alloc] init];
...
//    ROPayOrderInfo *order = [[[ROPayOrderInfo alloc] init] autorelease];
    ROPayOrderInfo *order = [[ROPayOrderInfo alloc] init];
    order.appID = kAPP_ID;
...
//        UIAlertView *alertView =[[[UIAlertView alloc] initWithTitle:@"错误提示" message:@"支付状态错误" delegate:nil cancelButtonTitle:@"ok" otherButtonTitles:nil] autorelease];
        UIAlertView *alertView =[[UIAlertView alloc] initWithTitle:@"错误提示" message:@"支付状态错误" delegate:nil cancelButtonTitle:@"ok" otherButtonTitles:nil];
        [alertView show];
        return;
    }
...
//    UIAlertView *alertView =[[[UIAlertView alloc] initWithTitle:@"错误提示" message:[error localizedDescription] delegate:nil cancelButtonTitle:@"确定" otherButtonTitles:nil] autorelease];
    UIAlertView *alertView =[[UIAlertView alloc] initWithTitle:@"错误提示" message:[error localizedDescription] delegate:nil cancelButtonTitle:@"确定" otherButtonTitles:nil];
    [alertView show];
}
...
//                ROPayError *error = [[[ROPayError alloc] init] autorelease];
                ROPayError *error = [[ROPayError alloc] init];
...
//        UIAlertView *alertView =[[[UIAlertView alloc] initWithTitle:@"错误提示" message:@"很抱歉，订单存储错误，无法完成修复" delegate:nil cancelButtonTitle:@"确定" otherButtonTitles:nil] autorelease];
        UIAlertView *alertView =[[UIAlertView alloc] initWithTitle:@"错误提示" message:@"很抱歉，订单存储错误，无法完成修复" delegate:nil cancelButtonTitle:@"确定" otherButtonTitles:nil];
        [alertView show];
        return;
    }
