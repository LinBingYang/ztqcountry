...
//    id<RORequestDebugDelegate> _debugDelegate;
    __weak id<RORequestDelegate> _delegate;
    __weak id<RORequestDebugDelegate> _debugDelegate;
    NSString *_url;
...
@property(nonatomic, weak) id<RORequestDelegate> delegate;

@property(nonatomic, weak) id<RORequestDebugDelegate> debugDelegate;
...
@property(nonatomic, strong) RORequestParam *requestParamObject;

@property(nonatomic, strong) ROResponse *responseObject;
